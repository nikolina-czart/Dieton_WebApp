...
const DayComponent = ({ dayNumber, monthName, monthNumber, yearNumber, month }) => {
    const value = 100
    const maxValue = 1000
        ...
        <>
            <div>
                {isCurrentDay() ?
                    ...
                    :
                    <div className={isCurrentMonth() ? "bg-white w-[140px] drop-shadow-basic rounded-20 p-[15px]" : "bg-white w-[140px] drop-shadow-basic rounded-20 p-[15px] brightness-75"}>
